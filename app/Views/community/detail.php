<div class="d-flex justify-content-center   " >
    <div class="d-flex flex-column px-5    w-100" style="max-width:1440px;" >
        ...
        <div class="grid  mt-150" >
            ...
            <div class="d-flex flex-row justify-content-start fw-bold gap-4" style="font-size: 32px;">
                <p class="cursor-pointer <?= $gubunNum != 1 ? 'ojak-light-gray hover-underline' : 'text-decoration-underline' ?>">공지사항</p>
                <p class="cursor-pointer <?= $gubunNum != 2 ? 'ojak-light-gray hover-underline' : 'text-decoration-underline' ?>">이벤트</p>
                <p class="cursor-pointer <?= $gubunNum != 3 ? 'ojak-light-gray hover-underline' : 'text-decoration-underline' ?>">Q&A</p>
            </div>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="cursor-pointer hover-underline">
                            <a href="/community/detail/1?index=1&gubunNum=<?=$gubunNum?>">
                                오작에 대한 공지사항 제목 글 내용
                            </a>
                        </td>
                        <td>작성자</td>
                    ...
                    <tr>
                        <td>5</td>
                        <td class="cursor-pointer hover-underline">오작에 대한 공지사항 제목 글 내용</td>
                        <td>작성자</td>
                        <td>2025-01-03</td>
                        <td>2</td>
                    </tr>
        ...
        <div class="d-flex flex-row justify-content-center gap-4" style="margin-top:43px;">
            ...
            <div style="font-size:20px;" class="cursor-pointer <?=$pageIndex != 1 ? 'ojak-light-gray hover-underline' : 'text-decoration-underline' ?>">
                1
            </div>
            <div style="font-size:20px;" class="cursor-pointer <?=$pageIndex !=2 ? 'ojak-light-gray hover-underline' : 'text-decoration-underline' ?>">
                2
            </div>
            <div style="font-size:20px;" class="cursor-pointer <?=$pageIndex != 3 ? 'ojak-light-gray hover-underline' : 'text-decoration-underline' ?>">
                3
            </div>
            <div style="font-size:20px;" class="cursor-pointer <?=$pageIndex != 4 ? 'ojak-light-gray hover-underline' : 'text-decoration-underline' ?>">
                4
            </div>
            <div style="font-size:20px;" class="cursor-pointer <?=$pageIndex != 5? 'ojak-light-gray hover-underline' : 'text-decoration-underline' ?>">
                5
            </div>
            <div>
                <svg width="10" height="16" viewBox="0 0 10 16" fill="none" xmlns="http://www.w3.org/2000/svg">
