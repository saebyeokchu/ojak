...
<header class="fixed-top for-sm bg-transparent" id="smHeader">
    ...
    <div class="d-flex flex-row justify-content-between px-5 py-2 align-items-center">
        ...
        <?php }else{ ?>
            <div class="cursor-pointer" id="openModalMobileBtn">
        ...
        <div class="container d-flex justify-content-between align-items-start  pt-5" id="header-inner-wrapper" > 
            ...
            <div class="d-flex gx-3 gap-4">
                ...
                <?php }else{ ?>
                    ...
                    <a class="nav-link cursor-pointer hover-underline fs-6" id="openModalBtn">로그인</a>
                <?php } ?>
                <!-- blog -->
                ...
                <svg class="cursor-pointer" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
