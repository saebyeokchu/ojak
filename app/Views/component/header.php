    ...
    <header class="fixed-top for-lg bg-transparent text-white " id="lg-header" >
        ...
        <div id="lg-header-toggle-div" class="mh-100 fixed-top z-3 d-flex flex-column bg-black text-white" style="width:211px; height: -webkit-fill-available; transform: translateX(-100vh); transition: transform 0.8s ease-in-out;">
            ...
            <div class="d-flex justify-content-center text-center cursor-pointer pt-15" >
                <div class="d-felx flex-column mt-4 g-3" style="list-style: none;">
                    <?php if(isset($_COOKIE["user_id"])) { ?>
                        <div>
                        <a id="toggleMyPageText" class="mt-2 nav-link toggle-header-menu <?=$lgMypageUrl?>" href="/my/home">마이페이지</a>
                        </div>
                    <?php } ?>
...
.hover-underline-test {
    position: relative;
    display: inline-block;
    text-decoration: none; /* Remove default underline */
}

.hover-underline-test-two-word {
    position: relative;
    display: inline-block;
    text-decoration: none; /* Remove default underline */
}

.hover-underline-test-three-word {
    position: relative;
    display: inline-block;
    text-decoration: none; /* Remove default underline */
}

.hover-underline-test::after {
    content: "";
    position: absolute;
    left: 0;
    top: 23px; /* Adjust this value to control the gap */
    width: 100%;
    height: 2px; /* Thickness of the underline */
    transform: scaleX(0);
}

.hover-underline-test-two-word::after {
    content: "";
    position: absolute;
    left: 0;
    top: 23px; /* Adjust this value to control the gap */
...
.hover-underline-test-three-word::after {
    content: "";
    position: absolute;
    left: 0;
    top: 23px; /* Adjust this value to control the gap */
...
.hover-underline-test-white::after {
    background-color: white;
}

.hover-underline-test-black::after {
    background-color: black;
}

.hover-underline-test:hover::after {
    transform: scaleX(1);
}

.hover-underline-test-two-word:hover::after {
    transform: scaleX(1);
}


.hover-underline-test-three-word:hover::after {
    transform: scaleX(1);
}
