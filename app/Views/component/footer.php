    ...
    <div class="for-lg d-flex justify-content-center">
        <div class="d-flex justify-content-between py-5 w-full   px-5" style="max-width:1440px;">
            ...
            <div class="d-flex gx-3 gap-4 for-sm">
                <!-- blog -->
                <svg id="footerNaverLogoLg" class="cursor-pointer" width="29" height="30" viewBox="0 0 29 30"  xmlns="http://www.w3.org/2000/svg"  onclick="location.href=''">
                ...
                <svg id="footerInstaLogoLg" class="cursor-pointer" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" onclick="location.href='https://www.instagram.com/ko_jeong_suk/'">
                ...
                <!-- youtube -->
                <svg id="footerYoutubeLogoLg" width="29" height="30" viewBox="0 0 29 30"  xmlns="http://www.w3.org/2000/svg">
...
<footer class=" bg-light px-5 for-sm">
    <div class="d-flex flex-column py-3">
        <div class="d-flex gx-3 gap-4 for-sm ">
            ...
            <!-- youtube -->
            <svg  id="footerYoutubeLogo" class="cursor-pointer" width="29" height="30" viewBox="0 0 29 30"  xmlns="http://www.w3.org/2000/svg">
                <path class="scrollIcon" fill="#000" fill-rule="evenodd" clip-rule="evenodd" d="M24.8892 5.89461C26.0334 6.20992 26.9337 7.14616 27.2385 8.33949C27.7918 10.4982 27.7871 14.9998 27.7871 14.9998C27.7871 14.9998 27.7871 19.5015 27.2338 21.6602C26.929 22.8487 26.0287 23.7849 24.8845 24.1051C22.8119 24.6823 14.4978 24.6823 14.4978 24.6823C14.4978 24.6823 6.18379 24.6823 4.11114 24.1051C2.96696 23.7897 2.06663 22.8535 1.76183 21.6602C1.2085 19.5015 1.2085 14.9998 1.2085 14.9998C1.2085 14.9998 1.2085 10.4982 1.76652 8.33464C2.07132 7.14616 2.97165 6.20992 4.11583 5.88976C6.18848 5.3125 14.5025 5.3125 14.5025 5.3125C14.5025 5.3125 22.8119 5.3125 24.8892 5.89461ZM18.7322 14.9999L11.7827 10.9105V19.0892L18.7322 14.9999Z" fill="white"/>
            </svg>
        </div>
