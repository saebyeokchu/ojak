...
<?php if($isLoggedIn) { ?>
    <nav class="navbar navbar-expand-lg flex justify-content-center text-black">
        <div class="w-100 d-flex justify-content-between pt-5 px-5"  style="max-width:1440px;">
            <!-- Left -->
            <div class="d-flex ">
                <a class="nav-link cursor-pointer me-4" aria-current="page" onclick="openToggleDiv(event)">
                    <svg width="20px" height="20px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path  d="M5 6H12H19M5 12H19M5 18H19" stroke="#000" stroke-width="2" stroke-linecap="round"/>
                    </svg>
                </a>
                ...
                <div 
                    ...
                    onmouseenter="showcommunitydiv('smBlackLogoCommunity');"  
                    onmouseleave="hidecommunitydiv('smBlackLogoCommunity');">
                    <a 
                        href="/community/notice?pageIndex=1" 
                        class=" nav-link <?=$lgCommunityUrl?> me-4" 
                    >
                        커뮤니티
                    </a>
                    <div 
                        id="smBlackLogoCommunity" 
                        class="position-absolute d-flex flex-column gap-4 py-3 pe-5 ps-3 px bg-light text-left hide-y-gradually " 
                        style="top:35px; width:120px;">
                        <a 
                            class="nav-link cursor-hover cursor-pointer <?=$lgNoticeUrl?> text-black" 
                            href="/community/notice?pageIndex=1" 
                            >공지사항</a>
                        <a 
                            class="nav-link cursor-hover cursor-pointer <?=$lgEventUrl?> text-black" 
                            href="/community/event?pageIndex=1" 

                        >이벤트</a>
                        <a 
                            class="nav-link cursor-hover cursor-pointer <?=$lgQnaUrl?> text-black" 
            ...
            <div class="d-flex navbar-brand">
                <a href="/" >
                    <svg id="lgHeaderMiddleLogo" width="68" height="117" viewBox="0 0 79 135" fill="none" xmlns="http://www.w3.org/2000/svg" >
                        <g clip-path="url(#clip0_320_463)" id="lg-header-logo-black">
    ...
    <nav class="navbar navbar-expand-lg flex justify-content-center text-black">
        <div class="w-100 d-flex justify-content-between pt-5 px-5"  style="max-width:1440px;">
            ...
            <div class="d-flex ">
                ...
                <a 
                    id="lgHeaderBrandText" 
                    class="nav-link cursor-pointer <?=$lgBrandUrl?>  me-4" 
                    aria-current="page" 
                    href="/brand" >
                    브랜드
                </a>
                ...
                <a 
                    id="lgHeaderGalleryText" 
                    class="nav-link cursor-pointer <?=$lgGalleryUrl?>  me-4" 
                    href="/gallery?pageIndex=1"
                >갤러리</a>

                <div 
                    class="position-relative" 
                    onmouseenter="showcommunitydiv('smBlackLogoCommunityLogout');"  
                    onmouseleave="hidecommunitydiv('smBlackLogoCommunityLogout');">
                    <a 
                    ...
                    <div 
                        ...
                        <a 
                            class="nav-link cursor-hover cursor-pointer <?=$lgNoticeUrl?> text-black" 
                            href="/community/notice?pageIndex=1"  >공지사항</a>
                        <a 
                            class="nav-link cursor-hover cursor-pointer <?=$lgEventUrl?> text-black" 
                            href="/community/event?pageIndex=1" 
                        >이벤트</a>
            ...
            <div class="d-flex navbar-brand">
                <a href="/" >
                    <svg width="68" height="117" viewBox="0 0 79 135" fill="none" xmlns="http://www.w3.org/2000/svg" >
            ...
            <div class="d-flex">
                ...
                >로그인</a>
                <!-- naver blog -->
                <svg class="cursor-pointer me-4" width="29" height="30" viewBox="0 0 29 30"  xmlns="http://www.w3.org/2000/svg" onclick="window.open(
                            'https://blog.naver.com/ojak_kjs',
                            '_blank' 
                    );">
                    <path class="scrollIcon" fill="#000" d="M6.96927 12.3663C6.67963 12.3663 6.42217 12.4844 6.22907 12.7037C6.01989 12.9229 5.92334 13.1928 5.92334 13.5133C5.92334 13.8337 6.01989 14.0867 6.22907 14.3229C6.43826 14.5421 6.67963 14.6602 6.96927 14.6602C7.25891 14.6602 7.51637 14.5421 7.72556 14.3229C7.93475 14.1036 8.04738 13.8337 8.04738 13.5133C8.04738 13.1928 7.93475 12.9229 7.72556 12.7037C7.51637 12.4675 7.275 12.3663 6.96927 12.3663Z" fill="black"/>
                ...
                <svg class="cursor-pointer me-4" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" onclick="window.open(
                            'https://www.instagram.com/ko_jeong_suk/',
                            '_blank' 
                    );">
                    <path class="scrollIcon" fill="#000"id="lg-header-insta-icon1" d="M14.9998 11.0419C12.8602 11.0419 11.0415 12.8606 11.0415 15.0002C11.0415 17.1398 12.8602 18.9585 14.9998 18.9585C17.1395 18.9585 18.9582 17.1398 18.9582 15.0002C18.9582 12.8606 17.1395 11.0419 14.9998 11.0419Z" fill="black"/>
