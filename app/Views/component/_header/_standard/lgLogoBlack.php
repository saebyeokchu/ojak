        ...
        <div class="w-100 d-flex justify-content-between pt-5 px-5"  style="max-width:1440px;">
            ...
            <div class="d-flex ">
                ...
                <div 
                    ...
                    onmouseenter="showcommunitydiv('lgBlackLogoCommunity');"  
                    onmouseleave="hidecommunitydiv('lgBlackLogoCommunity');">
                    <a 
    ...
    <nav class="navbar navbar-expand-lg flex justify-content-center text-black">
        <div class="w-100 d-flex justify-content-between pt-5 px-5"  style="max-width:1440px;">
            ...
            <div class="d-flex ">
                ...
                <div 
                    class="position-relative" 
                    onmouseenter="showcommunitydiv('lgLogoBlackLogout');"  
                    onmouseleave="hidecommunitydiv('lgLogoBlackLogout');">
                    <a 
                        href="/community/notice?pageIndex=1" 
