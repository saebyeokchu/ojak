        ...
        <div id="sm-header-toggle-div" class="mh-100 fixed-top z-3 d-flex flex-column bg-black text-white" style="width:300px; height: 100vh; transform: translateX(-100vh); transition: transform 0.8s ease-in-out;">
            ...
            <div class="d-flex text-center cursor-pointer pt-3" >
                <div class="d-felx flex-column gap-3 gy-3" style="list-style: none;">
                    ...
                    <a class="nav-link pt-3 toggle-header-menu <?=$lgCommunityUrl?>" href="/community/notice?pageIndex=1" style="width:300px;">커뮤니티</a>
                    <!-- <div  onmouseenter="showcommunitydiv('mobile-header-community-submenu')"  onmouseleave="hidecommunitydiv('mobile-header-community-submenu')">
                        ...
                        <div id="mobile-header-community-submenu" class="hide-y-gradually d-felx flex-column text-center " >
                            <a id="mobileNoticeMenu" class="nav-link pt-3 toggle-header-menu "   >공지사항</a>
                            <a id="mobileEventMenu" class="nav-link pt-3 toggle-header-menu "   >이벤트</a>
                            <a id="mobileQnaMenu" class="nav-link pt-3 toggle-header-menu "  >Q&A</a>
                        </div>
                    </div> -->
