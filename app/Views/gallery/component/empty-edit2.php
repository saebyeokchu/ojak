<div class="hovereffect cursor-pointer">
    ...
    <!-- <h2>Hover effect 1</h2> -->
        <a class="info cursor-pointer" data-bs-toggle="modal" data-bs-target="#postGallery2">전시</a>
    </div>
</div>

<!-- Modal -->
<div class="modal fade" id="postGallery2" tabindex="-1" aria-labelledby="postGallery2" aria-hidden="true">
