...
<div class="hovereffect cursor-pointer">
    ...
    <!-- <h2>Hover effect 1</h2> -->
        <a class="info cursor-pointer" data-bs-toggle="modal" data-bs-target="#postGallery4">수정</a>
        <a class="info cursor-pointer" onClick="deleteByGalleryId('<?= $id ?>')">삭제</a>
    </div>
</div>

<!-- Modal -->
<div class="modal fade" id="postGallery4" tabindex="-1" aria-labelledby="postGallery4" aria-hidden="true">
